...
6: Get WQP Data using R.
 EDIT 20 Dec 2024: "StationName" was changed to "MonitoringLocationIdentifier" in WQP by Environmental Protection Agency. Code changed to reflect this. (Damstra, NPS)
 EDIT 20 Dec 2024: Filename "GLKNStations.csv" was changed to "station.csv" to reflect name of .csv file containg site metadata in GitHub repository. 
...
# Add lat long
locations <- locations %>% select(GLKNStationID, LatitudeMeasure, LongitudeMeasure, MonitoringLocationIdentifier, Park)
